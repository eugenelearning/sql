...
не удается использовать preferred_hotel_type использовать ни в case ни в функциях
...
падают с ошибкой ERROR: column "preferred_hotel_type" does not exist

подскажите пожалуйста, в чем причина и где я ошибаюсь
*/ 
with
